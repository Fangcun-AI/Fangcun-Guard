<div align="center">
  <h1>Fangcun Guard</h1>
  <p>Open-Source AI Security Infrastructure</p>
...
Fangcun Guard is an open-source AI security infrastructure for protecting AI applications and agents across content safety, prompt attacks, data leakage, agent runtime behavior, and grounded generation.

## Highlights

- **Fangcun Guard Router**: 15 predefined safety dimensions with a classification router that automatically identifies the relevant dimension for each input and dispatches it to the corresponding detection model. Users can freely choose which model to use for each dimension.
...
See [Fangcun Guard Router docs](docs/features/GUARD_MODEL_ROUTER.md)
...
- [Fangcun Guard Router](docs/features/GUARD_MODEL_ROUTER.md) — Multi-model routing configuration
- [Fangcun Core Shield](docs/features/BASIC_GUARD_OVERVIEW.md) — Core safety capabilities
- [Agent Runtime Firewall](docs/features/AGENT_SAFETY_OVERVIEW.md) — Agent protection
