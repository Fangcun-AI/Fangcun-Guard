...
Uses the Qwen3Guard-Gen-8B model via model_service.check_messages_with_scanner_definitions()
...
class ContentScanService:
    ...
    def _build_risk_content(self, risk_types: List[str], scan_type: str) -> List[str]:
        """
        ...
        return [RISK_DESCRIPTIONS.get(rt, f"Unknown risk type: {rt}") for rt in risk_types]
