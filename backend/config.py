...
class Settings(BaseSettings):
    ...
    data_dir: str = "/mnt/data/fangcunguard-data"
    ...
    database_url: str = "postgresql://fangcunguard:your_password@localhost:54321/fangcunguard"
    ...
    general_llm_api_url: str = "http://your-host-ip:your-port/v1"
    ...
    guardrails_vl_model_name: str = "Qwen3Guard-VL"
    ...
    prompt_guard_url: str = "http://127.0.0.1:58006"

    # Guard Model Router configuration
    # Path to guard_models.yaml (relative to backend/ or absolute). Empty = disabled.
    guard_models_config_path: str = ""

    # Scanner performance tuning
    scanner_regex_cache_size: int = 1024
    scanner_keyword_cache_size: int = 1024
    scanner_keyword_regex_threshold: int = 8
    scanner_match_sample_limit: int = 5
    scanner_regex_match_count_limit: int = 200
    scanner_window_max_windows: int = 12
    scanner_window_max_pairs: int = 64
    scanner_window_concurrency: int = 8
    ...
    embedding_model_name: str = "FangcunGuard-Embedding-1024"
    ...
    # HuggingFace model
    huggingface_model: str = "Qwen/Qwen3Guard-Gen-8B"
    ...
    frontend_url: str = "https://fangcunguard.com"
    ...
    api_domain: str = "https://api.fangcunguard.com" if deployment_mode.lower() == "saas" else "http://localhost:5001"
