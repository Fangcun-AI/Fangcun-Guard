-- FangcunGuard Platform - PostgreSQL database initialization script
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'FangcunGuard database initialization completed successfully!';
    RAISE NOTICE 'All tables, indexes, triggers, and default data have been created.';
    RAISE NOTICE 'Default admin account: admin@fangcunguard.com';
