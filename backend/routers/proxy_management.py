    ...
    try:
        ...
        try:
            ...
            api_config = UpstreamApiConfig(
                ...
                reasoning_format=request_data.get('reasoning_format', 'auto') if request_data.get('reasoning_format') in ('auto', 'field', 'tag', 'none') else 'auto',
        ...
        try:
            ...
            for field, value in request_data.items():
                if field == 'api_key':
                    ...
                    # Handle reasoning format enum field
                    if value in ('auto', 'field', 'tag', 'none'):
