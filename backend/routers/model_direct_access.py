...
def resolve_model_backend(model_name: str) -> dict:
    ...
    # FangcunGuard-Text model (guardrails detection model)
    if 'fangcunguard-text' in model_name_lower or 'guardrails-text' in model_name_lower or 'og-text' in model_name_lower:
        return {
    ...
    # FangcunGuard-VL model (vision-language model)
    elif 'fangcunguard-vl' in model_name_lower or 'guardrails-vl' in model_name_lower or 'og-vl' in model_name_lower:
        return {
...
async def model_chat_completions(
    ...
    client = OpenAI(
        base_url="https://api.fangcunguard.com/v1/model/",
