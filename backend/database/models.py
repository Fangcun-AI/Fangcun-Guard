...
class DetectionResult(Base):
    ...
    agent_safety_risk_level = Column(String(20), default='no_risk')
    agent_safety_categories = Column(JSON, default=list)
    # Hallucination detection results
    hallucination_risk_level = Column(String(20), default='no_risk')
    hallucination_categories = Column(JSON, default=list)
...
class UpstreamApiConfig(Base):
    ...
    reasoning_format = Column(String(20), default='auto')  # Reasoning extraction format: auto, field, tag, none
...
class ScannerPackage(Base):
    ...
    author = Column(String(200), nullable=False, default='FangcunGuard')
    description = Column(Text)
...
class AgentSafetyPolicy(Base):
    """Per-application agent safety policy configuration"""
    __tablename__ = "agent_safety_policies"
    ...
    tool_whitelist = Column(JSON, default=None, nullable=True)  # NULL = allow all
    tool_blacklist = Column(JSON, default=list)  # [] = block none
    max_tool_calls_per_request = Column(Integer, nullable=False, default=20)
    enable_argument_inspection = Column(Boolean, nullable=False, default=True)
    argument_patterns = Column(JSON, default=list)  # Custom regex patterns
    enable_reasoning_safety = Column(Boolean, nullable=False, default=False)
    enable_tool_definition_scan = Column(Boolean, nullable=False, default=True)  # Scan JSON tool definitions
    tool_violation_action = Column(String(20), nullable=False, default='block')  # block|warn|log
    reasoning_violation_action = Column(String(20), nullable=False, default='warn')  # block|warn|log
    tool_definition_scan_action = Column(String(20), nullable=False, default='warn')  # block|warn|log
    ...
    __table_args__ = (
        UniqueConstraint('application_id', name='uq_agent_safety_policy_app'),
    )


class HallucinationPolicy(Base):
    """Per-application hallucination detection policy"""
    __tablename__ = "hallucination_policies"
    ...
    enabled = Column(Boolean, nullable=False, default=False)
    enable_groundedness = Column(Boolean, nullable=False, default=True)
    enable_consistency = Column(Boolean, nullable=False, default=True)
    groundedness_threshold = Column(Float, nullable=False, default=0.7)
    consistency_threshold = Column(Float, nullable=False, default=0.7)
    source_context_field = Column(String(100), nullable=False, default='system_message')  # system_message|extra_body.context|extra_body.documents
    violation_action = Column(String(20), nullable=False, default='flag')  # block|flag|warn|log
    ...
    __table_args__ = (
        UniqueConstraint('application_id', name='uq_hallucination_policy_app'),
    )


class BasicGuardPolicy(Base):
    """Per-application basic guard policy"""
    __tablename__ = "basic_guard_policies"
    ...
    enable_content_pattern_check = Column(Boolean, nullable=False, default=True)
    enable_reasoning_divergence_check = Column(Boolean, nullable=False, default=True)
    enable_output_anomaly_check = Column(Boolean, nullable=False, default=True)
    max_repetition_ratio = Column(Float, nullable=False, default=0.4)
    min_content_length = Column(Integer, nullable=False, default=10)
    violation_action = Column(String(20), nullable=False, default='warn')  # block|warn|log

    # Prompt Injection detection (Prompt Guard 2)
    enable_prompt_injection_check = Column(Boolean, nullable=False, default=True)
    prompt_injection_threshold = Column(Float, nullable=False, default=0.5)
    prompt_injection_action = Column(String(20), nullable=False, default='block')  # block|warn|log
    scan_user_messages = Column(Boolean, nullable=False, default=True)
    scan_system_messages = Column(Boolean, nullable=False, default=True)
    ...
    __table_args__ = (
        UniqueConstraint('application_id', name='uq_basic_guard_policy_app'),
    )


class SkillScannerPolicy(Base):
    """Per-application skill scanner policy"""
    __tablename__ = "skill_scanner_policies"
    ...
    enabled = Column(Boolean, nullable=False, default=False)
    enable_static_pattern = Column(Boolean, nullable=False, default=True)
    enable_structural_validation = Column(Boolean, nullable=False, default=True)
    enable_capability_risk = Column(Boolean, nullable=False, default=True)
    enable_llm_semantic = Column(Boolean, nullable=False, default=False)
    llm_auto_trigger_on_medium = Column(Boolean, nullable=False, default=True)
    policy_mode = Column(String(20), nullable=False, default='balanced')
    critical_action = Column(String(20), nullable=False, default='block')
    high_action = Column(String(20), nullable=False, default='warn')
    medium_action = Column(String(20), nullable=False, default='log')
    low_action = Column(String(20), nullable=False, default='log')
    custom_patterns = Column(JSON, default=list)
    dangerous_capability_keywords = Column(JSON, default=list)
    ...
    __table_args__ = (
        UniqueConstraint('application_id', name='uq_skill_scanner_policy_app'),
    )


class McpScannerPolicy(Base):
    """Per-application MCP scanner policy"""
    __tablename__ = "mcp_scanner_policies"
    ...
    enabled = Column(Boolean, nullable=False, default=False)
    enable_yara_rules = Column(Boolean, nullable=False, default=True)
    enable_llm_semantic = Column(Boolean, nullable=False, default=False)
    enable_behavior_analysis = Column(Boolean, nullable=False, default=True)
    llm_auto_trigger_on_medium = Column(Boolean, nullable=False, default=True)
    enable_tool_scan = Column(Boolean, nullable=False, default=True)
    enable_prompt_scan = Column(Boolean, nullable=False, default=True)
    enable_resource_scan = Column(Boolean, nullable=False, default=True)
    enable_instruction_scan = Column(Boolean, nullable=False, default=True)
    enable_supply_chain = Column(Boolean, nullable=False, default=False)
    policy_mode = Column(String(20), nullable=False, default='balanced')
    critical_action = Column(String(20), nullable=False, default='block')
    high_action = Column(String(20), nullable=False, default='warn')
    medium_action = Column(String(20), nullable=False, default='log')
    low_action = Column(String(20), nullable=False, default='log')
    custom_yara_rules = Column(JSON, default=list)
    trusted_servers = Column(JSON, default=list)
    ...
    __table_args__ = (
        UniqueConstraint('application_id', name='uq_mcp_scanner_policy_app'),
    )
