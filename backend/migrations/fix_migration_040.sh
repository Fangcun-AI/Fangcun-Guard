...
CONTAINER_NAME="${POSTGRES_CONTAINER:-fangcunguard-postgres}"
DB_USER="${POSTGRES_USER:-fangcunguard}"
DB_NAME="${POSTGRES_DB:-fangcunguard}"
...
echo "   docker restart fangcunguard-admin"
echo "   # or"
echo "   docker compose restart admin"
echo ""
echo "3. Check migration logs:"
echo "   docker logs fangcunguard-admin 2>&1 | grep -i migration"
echo ""
