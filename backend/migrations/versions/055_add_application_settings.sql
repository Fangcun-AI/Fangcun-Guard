...
CREATE TABLE IF NOT EXISTS application_settings (
    ...
    security_risk_template JSONB DEFAULT '{"en": "Request blocked by FangcunGuard due to possible violation of policy related to {scanner_name}.", "zh": "请求已被FangcunGuard拦截，原因：可能违反了与{scanner_name}有关的策略要求。"}',
    data_leakage_template JSONB DEFAULT '{"en": "Request blocked by FangcunGuard due to possible sensitive data ({entity_type_names}).", "zh": "请求已被FangcunGuard拦截，原因：可能包含敏感数据（{entity_type_names}）。"}',
