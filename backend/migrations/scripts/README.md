...
This directory contains maintenance scripts for FangcunGuard database. These scripts are safe to run multiple times and are designed to fix or update data after migrations or system upgrades.
...
**Good news!** If you're deploying FangcunGuard for the first time or from the latest version, you don't need to run these scripts. The application now automatically:
...
4. Contact support at thomas@fangcunguard.com
