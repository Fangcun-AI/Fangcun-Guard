      ...
      <Card>
        <CardContent className="pt-6">
          <div className="space-y-6">
            ...
            <div className="p-4 bg-yellow-950/50 border border-yellow-800 rounded-lg">
        ...
        <CardContent className="pt-6">
          <div className="space-y-6">
            ...
            {!isAlipay && subscription.subscription_type === 'free' && paymentConfig && paymentConfig.tiers && paymentConfig.tiers.length > 0 && (
              <div className="p-4 bg-indigo-950/50 border border-indigo-800 rounded-lg space-y-4">
                <div>
                  <p className="font-semibold text-indigo-200">{t('billing.upgradeAvailable')}</p>
                  <p className="text-sm text-indigo-300 mt-1">{t('billing.upgradeDescription')}</p>
                </div>
                <TierSelector
            ...
            {!isAlipay && subscription.subscription_type === 'free' && paymentConfig && (!paymentConfig.tiers || paymentConfig.tiers.length === 0) && (
              <div className="p-4 bg-indigo-950/50 border border-indigo-800 rounded-lg">
                ...
                <div className="mt-2 space-y-2">
                  <p className="text-sm text-indigo-300">{t('billing.upgradeDescription')}</p>
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                <p className="text-sm font-medium text-zinc-400">{t('billing.currentUsage')}</p>
              ...
              <div>
                <p className="text-sm font-medium text-zinc-400">{t('billing.remaining')}</p>
                <p
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-sm text-zinc-400">{t('billing.days')}</span>
                </div>
              </div>
            </div>
            ...
            {subscription.purchased_quota > 0 && (
              <div className="p-4 bg-green-950/50 border border-green-800 rounded-lg">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-green-400">{t('billing.purchasedQuota')}</p>
                  ...
                  {subscription.purchased_quota_expires_at && (
                    <div>
                      <p className="text-sm font-medium text-green-400">{t('billing.quotaExpiresOn', {
            ...
            {subscription.usage_breakdown && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-zinc-800/50 rounded-lg">
                <div>
                  <p className="text-sm font-medium text-zinc-400">
            ...
            <div className="p-4 bg-indigo-950/50 border border-indigo-800 rounded-lg">
              <div className="space-y-2">
                ...
                <p className="text-xs text-indigo-400">{t('billing.quotaResetNote')}</p>
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <p className="text-sm font-medium text-zinc-400">{t('billing.planType')}</p>
                <p className="font-semibold mt-1">{subscription.plan_name}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-zinc-400">{t('billing.monthlyQuota')}</p>
              ...
              <div>
                ...
                <p className="font-mono text-xs bg-zinc-800/50 px-2 py-1 rounded mt-1 inline-block">
                  {subscription.id}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-zinc-400">{t('billing.billingCycle')}</p>
