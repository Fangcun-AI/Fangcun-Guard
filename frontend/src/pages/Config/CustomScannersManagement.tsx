          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-zinc-400">{t('customScanners.premiumFeatureSubtitle')}</p>
              </div>
              ...
              <div className="max-w-2xl mx-auto p-6 bg-zinc-800/50 rounded-lg text-left">
  ...
  return (
    <div className="space-y-4">
      {features.showSubscription() && !premiumBannerDismissed && (
        <div className="p-4 bg-green-950/30 border border-green-800 rounded-lg relative">
          <button
            onClick={handleDismissPremiumBanner}
            className="absolute top-2 right-2 p-1 text-green-400 hover:text-green-300 hover:bg-green-900/50 rounded"
            title={t('common.close')}
          >
            <X className="h-4 w-4" />
          </button>
          <div className="flex items-center gap-2 text-green-200 font-semibold mb-1 pr-6">
            <Crown className="h-5 w-5 text-yellow-500" />
            <span>{t('customScanners.premiumActiveMessage')}</span>
          </div>
          <p className="text-sm text-green-300 pr-6">{t('customScanners.premiumActiveDesc')}</p>
        </div>
      )}

      <Collapsible open={guideOpen} onOpenChange={setGuideOpen} className="bg-zinc-800/50 rounded-lg border border-zinc-800">
        <CollapsibleTrigger asChild>
          <Button variant="ghost" className="w-full flex justify-between p-4 hover:bg-white/5">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg">
                ...
                <p className="text-sm text-zinc-400">{t('customScanners.example1Desc')}</p>
              </div>
              ...
              <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg">
                ...
                <p className="text-sm text-zinc-400">{t('customScanners.example2Desc')}</p>
              </div>
              ...
              <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg">
                ...
                <p className="text-sm text-zinc-400">{t('customScanners.example3Desc')}</p>
              </div>
            </div>
          </div>
        </CollapsibleContent>
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                      ...
                      <SelectContent>
                        <SelectItem value="genai">
                          <div>
                            ...
                            <div className="text-xs text-zinc-500">{t('customScanners.typeGenaiDesc')}</div>
                          </div>
                        </SelectItem>
                        <SelectItem value="regex">
                          <div>
                            <div className="font-semibold">{t('customScanners.typeRegex')}</div>
                            <div className="text-xs text-zinc-500">{t('customScanners.typeRegexDesc')}</div>
                          </div>
                        </SelectItem>
              ...
              {!editingScanner && (
                <div className="p-4 bg-indigo-950/50 border border-indigo-800 rounded-lg">
                  <p className="text-sm text-indigo-200">{t('customScanners.autoTag')}</p>
                </div>
              )}
