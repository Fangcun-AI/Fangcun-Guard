        ...
        return (
          <div className="flex items-center gap-3 text-xs">
            <div className="flex items-center gap-1" title={t('applicationManagement.riskTypesTooltip')}>
              <span className="text-zinc-400">{t('applicationManagement.scanners')}:</span>
            ...
            <div className="flex items-center gap-1" title={t('applicationManagement.dlpEntitiesTooltip')}>
              <span className="text-zinc-400">{t('applicationManagement.dlpEntities')}:</span>
          ...
          <DialogHeader>
            <DialogTitle>
              <div className="flex items-center gap-2">
                ...
                <span className="text-zinc-500 text-sm font-normal">({currentAppName})</span>
              </div>
            </DialogTitle>
          </DialogHeader>
          ...
          <SheetHeader>
            ...
            <SheetDescription>
              ...
              {selectedApp?.source === 'auto_discovery' && selectedApp?.external_id && (
                <span className="text-zinc-500 ml-2">({selectedApp.external_id})</span>
              )}
            </SheetDescription>
          </SheetHeader>
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-lg border p-3 space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-zinc-400">{t('applicationManagement.name')}:</span>
                    <span className="font-medium">{selectedApp.name}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-400">{t('applicationManagement.description')}:</span>
                    <span className="max-w-[250px] text-right">{selectedApp.description || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-400">{t('applicationManagement.status')}:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-zinc-400">{t('applicationManagement.source')}:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-zinc-400">{t('applicationManagement.createdAt')}:</span>
                  ...
                  {currentAppKeys.length > 0 ? (
                    <div className="space-y-2 max-h-[200px] overflow-y-auto">
                      {currentAppKeys.map((apiKey) => (
                        <div key={apiKey.id} className="flex items-center justify-between p-2 bg-zinc-800/50 rounded text-sm">
                          <div className="flex-1 min-w-0">
                            <div className="font-medium truncate">{apiKey.name || t('applicationManagement.unnamed')}</div>
                            <div className="flex items-center gap-1 mt-1">
                              <code className={`text-xs bg-zinc-700 px-1 py-0.5 rounded ${visibleKeys.has(apiKey.id) ? 'break-all' : 'truncate max-w-[200px]'}`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="rounded-lg border p-3 space-y-3 text-sm">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-zinc-400">{t('applicationManagement.sensitivityLevel')}:</span>
                        <Badge variant="secondary">
                          {t(`sensitivity.${selectedApp.protection_summary.sensitivity_level}`)}
                        </Badge>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-zinc-400">{t('applicationManagement.banPolicy')}:</span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-zinc-400">{t('applicationManagement.blacklist')}:</span>
                        <Badge variant="destructive">{selectedApp.protection_summary.blacklist_count}</Badge>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-zinc-400">{t('applicationManagement.whitelist')}:</span>
                        <Badge variant="outline">{selectedApp.protection_summary.whitelist_count}</Badge>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-zinc-400">{t('applicationManagement.knowledgeBase')}:</span>
