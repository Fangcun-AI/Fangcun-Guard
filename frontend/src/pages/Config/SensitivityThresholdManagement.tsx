  ...
  const columns: ColumnDef<SensitivityLevel>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <code className="text-xs bg-zinc-800/50 px-2 py-1 rounded">{value.toFixed(2)}</code>
      },
    },
    {
        ...
        <CardContent className="pt-6">
          <div className="space-y-6">
            <div>
              ...
              <p className="text-zinc-400 mt-2">{t('sensitivity.description')}</p>
            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="mt-2 p-2 bg-zinc-800/50 rounded border border-dashed border-zinc-700">
