...
const FalsePositiveAppeal: React.FC = () => {
  ...
  const getRiskBadgeClasses = (level: string): string => {
    ...
    return '!bg-zinc-800/50 !text-zinc-200 !border-zinc-800'
  }
            ...
            <div className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 border-b pb-3">
                  <div className="font-medium text-zinc-400 text-sm">{t('results.requestId')}:</div>
                  <div className="col-span-2">
                    <code className="text-xs bg-zinc-800/50 px-2 py-1 rounded">
                ...
                {/* Appeal User */}
                <div className="grid grid-cols-3 gap-4 border-b pb-3">
                  <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.appealUserColumn')}:</div>
                ...
                {/* Application */}
                <div className="grid grid-cols-3 gap-4 border-b pb-3">
                  <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.applicationColumn')}:</div>
                  <div className="col-span-2 text-sm">
                ...
                {/* Appeal Status */}
                <div className="grid grid-cols-3 gap-4 border-b pb-3">
                  <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.appealStatus')}:</div>
                  <div className="col-span-2">
                ...
                {/* Original Risk Level */}
                <div className="grid grid-cols-3 gap-4 border-b pb-3">
                  <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.originalRiskLevel')}:</div>
                  <div className="col-span-2">
                ...
                {selectedAppeal.original_categories && selectedAppeal.original_categories.length > 0 && (
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.originalCategories')}:</div>
                    <div className="col-span-2">
                ...
                {/* AI Review Result */}
                <div className="grid grid-cols-3 gap-4 border-b pb-3">
                  <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.aiReviewResult')}:</div>
                  <div className="col-span-2">
                ...
                {selectedAppeal.ai_review_result && (
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.reasonColumn')}:</div>
                ...
                {selectedAppeal.processor_type && (
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.processorInfo')}:</div>
                    <div className="col-span-2 text-sm">
                ...
                {/* Appeal Time */}
                <div className="grid grid-cols-3 gap-4 border-b pb-3">
                  <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.appealTime')}:</div>
                  <div className="col-span-2 text-sm">
                ...
                {(selectedAppeal.processed_at || selectedAppeal.ai_reviewed_at) && (
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.processTime')}:</div>
                    <div className="col-span-2 text-sm">
                ...
                {/* Original Content */}
                <div>
                  <div className="font-medium text-zinc-400 mb-3 text-sm">{t('appealConfig.originalContent')}:</div>
                  <div className="mt-2 p-4 bg-zinc-800/50 rounded-md">
              ...
              {selectedResult && (
                <div className="space-y-4">
                  ...
                  {/* Prompt Attack */}
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('results.promptAttack')}:</div>
                    <div className="col-span-2">
                  ...
                  {/* Data Leak */}
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('results.dataLeak')}:</div>
                    <div className="col-span-2">
                  ...
                  {/* Suggested Action */}
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('results.suggestedAction')}:</div>
                    <div className="col-span-2">
                  ...
                  {/* Detection Time */}
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('results.detectionTime')}:</div>
                    <div className="col-span-2 text-sm">
                  ...
                  {selectedResult.suggest_answer && (
                    <div>
                      <div className="font-medium text-zinc-400 mb-3 text-sm">
                        {t('results.suggestedAnswer')}:
                      </div>
                      <div className="mt-2 p-4 bg-indigo-950/50 rounded-md whitespace-pre-wrap text-sm">
                        {selectedResult.suggest_answer}
                      </div>
                    </div>
                  )}
                  ...
                  {selectedResult.ip_address && (
                    <div className="grid grid-cols-3 gap-4 border-b pb-3">
                      <div className="font-medium text-zinc-400 text-sm">{t('appealConfig.ipAddress')}:</div>
                      <div className="col-span-2">
                        <code className="text-xs bg-zinc-800/50 px-2 py-1 rounded">
                          {selectedResult.ip_address}
                        </code>
