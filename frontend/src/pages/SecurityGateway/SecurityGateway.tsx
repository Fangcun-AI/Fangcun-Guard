...
const ProxyModelManagement: React.FC = () => {
  ...
  const columns: ColumnDef<ProxyModel>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-2">
          <code className="px-2 py-1 bg-zinc-800/50 rounded text-xs font-mono">
            {row.original.id}
          </code>
          <Button
            variant="ghost"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="p-4 bg-indigo-950/30 border border-indigo-800 rounded-lg">
            <p className="text-sm text-indigo-300">{t('proxy.gatewayIntegrationDesc')}</p>
          </div>
          ...
          {viewingModel && (
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-2 py-2 border-b">
                <span className="font-medium text-zinc-200">{t('proxy.configName')}</span>
                <span className="col-span-2">{viewingModel.config_name}</span>
              </div>

              <div className="grid grid-cols-3 gap-2 py-2 border-b">
                <span className="font-medium text-zinc-200">{t('proxy.upstreamApiId')}</span>
              ...
              <div className="grid grid-cols-3 gap-2 py-2 border-b">
                ...
                <div className="col-span-2 space-y-2">
                  ...
                  {viewingModel.enable_reasoning_detection && viewingModel.reasoning_format && (
                    <Badge variant="secondary" className="bg-indigo-900/30 text-indigo-400 border-indigo-800">
