    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-2">
          <code className="px-2 py-1 bg-zinc-800/50 rounded text-sm">{row.original.model_pattern}</code>
      ...
      <Dialog open={isTestModalVisible} onOpenChange={setIsTestModalVisible}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            {testResult && (
              <div className={`p-4 rounded-md ${testResult.matched ? 'bg-green-950/30 border border-green-800' : 'bg-yellow-950/30 border border-yellow-800'}`}>
                {testResult.matched ? (
