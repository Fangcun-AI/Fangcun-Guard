    ...
    <Form {...registerForm}>
      <form onSubmit={registerForm.handleSubmit(handleRegister)} className="space-y-5">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-zinc-300">{t('register.emailPlaceholder')}</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-zinc-300">{t('register.passwordPlaceholder')}</FormLabel>
              <FormControl>
                <div className="relative">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-zinc-300">{t('register.confirmPasswordPlaceholder')}</FormLabel>
              <FormControl>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-zinc-500" />
                  <Input
      ...
      <Form {...verifyForm}>
        <form onSubmit={verifyForm.handleSubmit(handleVerify)} className="space-y-5">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-zinc-300">{t('register.verificationCodePlaceholder')}</FormLabel>
                <FormControl>
                  <div className="relative">
          ...
          <Button
            type="submit"
            className="w-full h-12 text-base font-medium bg-indigo-600 hover:bg-indigo-500 text-white"
            disabled={loading}
          >
        ...
        <div className="w-full max-w-md">
            ...
            <div className="px-6 pb-4">
              <div className="flex items-center justify-center gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xs font-medium ${currentStep === 0 ? 'text-white' : 'text-zinc-500'}`}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xs font-medium ${currentStep === 1 ? 'text-white' : 'text-zinc-500'}`}>
          ...
          <CardContent>
            ...
            <CardFooter className="flex-col pt-6">
              <div className="text-center text-sm">
                <span className="text-zinc-500">{t('register.alreadyHaveAccount')} </span>
