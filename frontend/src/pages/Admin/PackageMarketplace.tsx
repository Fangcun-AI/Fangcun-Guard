        ...
        <DialogContent className="sm:max-w-[600px]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-zinc-400">{t('packageMarketplace.jsonFormatHelp')}</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <span className="text-sm text-zinc-400">{i18n.language === 'zh' ? '元' : '$'}</span>
              </div>
              <p className="text-xs text-zinc-400">{t('packageMarketplace.priceHelp')}</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-zinc-400">Bundle name for grouping related packages</p>
            </div>
