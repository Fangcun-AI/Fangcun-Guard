      ...
      <Card className="flex-shrink-0">
        <CardContent className="pt-4 pb-4">
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <div className="relative">
              ...
              {filters.risk_level && (
                <button
                  ...
                  className="absolute -right-1 -top-1 w-4 h-4 bg-zinc-500 hover:bg-zinc-400 rounded-full flex items-center justify-center"
                >
            ...
            <div className="relative">
              ...
              {filters.content_search && (
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-zinc-500 hover:bg-zinc-400 rounded-full flex items-center justify-center"
                >
                  <X className="w-2.5 h-2.5 text-white" />
                </button>
              )}
            ...
            {hasActiveFilters() && (
              <Button variant="ghost" size="sm" onClick={handleResetAllFilters} className="h-8 text-xs text-zinc-400 hover:text-zinc-200">
            ...
            selectedResult && (
              <div className="space-y-4 mt-6">
                ...
                {selectedResult.ip_address && (
                  <div className="grid grid-cols-3 gap-4 border-b pb-3">
                    <div className="font-medium text-zinc-400 text-sm">{t('results.sourceIP')}:</div>
                    <div className="col-span-2">
                      <code className="text-xs bg-zinc-800/50 px-2 py-1 rounded">
                        {selectedResult.ip_address}
                      </code>
