...
const LanguageSwitcher: React.FC = () => {
  ...
  return (
    <Select value={i18n.language} onValueChange={handleLanguageChange} disabled={loading}>
      <SelectTrigger className="w-full h-9 text-sm border-zinc-700 bg-zinc-800/50 text-white focus:ring-indigo-500">
        <Languages className="h-4 w-4 mr-2 text-zinc-400" />
        <SelectValue />
      </SelectTrigger>
