        ...
        {tiers.map((tier) => {
          ...
          return (
            <Card
              ...
              className={`relative ${isCurrent ? 'border-indigo-500 border-2' : 'border'}`}
            >
              <CardContent className="pt-4 pb-4 space-y-3">
                {isCurrent && (
                  <Badge className="absolute -top-2 right-3 bg-indigo-600">
                ...
                <div className="text-2xl font-bold">
                  ...
                  <span className="text-sm font-normal text-zinc-500">/{t('billing.month')}</span>
                </div>
                {isCurrent ? (
