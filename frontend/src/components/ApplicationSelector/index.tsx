...
const ApplicationSelector: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-1.5">
      <span className="text-xs font-medium text-zinc-400 whitespace-nowrap">{t('applicationSelector.label')}:</span>
      <Select value={displayValue} onValueChange={handleChange} disabled={loading}>
        <SelectTrigger className="w-[280px] h-9 text-xs border-zinc-700 bg-zinc-800/50 text-white focus:ring-indigo-500 !px-2">
          {loading ? (
