  ...
  return (
    <div className={fillHeight ? "h-full flex flex-col" : "space-y-4"}>
                  ...
                  {row.getVisibleCells().map((cell, index) => {
                    ...
                    return (
                      <TableCell
                        ...
                        className={isLast ? "!bg-zinc-900 shadow-[-4px_0_8px_-4px_rgba(0,0,0,0.3)]" : ""}
                      >
                        {flexRender(
      ...
      {pagination && totalPages > 0 && (
        <div className={fillHeight ? "flex-shrink-0 flex items-center justify-between px-2 py-4 border-t border-zinc-800 bg-zinc-900" : "flex items-center justify-between px-2"}>
