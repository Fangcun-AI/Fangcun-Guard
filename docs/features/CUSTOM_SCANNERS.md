...
**Custom Scanners** are one of FangcunGuard' most powerful features, allowing you to create domain-specific detection logic without code changes.
...
**FangcunGuard' Scanner System solves this:**
...
FangcunGuard uses a flexible **three-tier scanner architecture**:
...
Premium scanner packages from FangcunGuard team:
...
- **Updates**: Regular updates from FangcunGuard team
...
FangcunGuard supports three scanner implementation types:

### 1. GenAI Scanner (Intelligent)

**Best for**: Complex concepts, contextual understanding

**How it works**: Uses Qwen3Guard-Gen-8B model for intelligent detection
...
client = FangcunGuard(api_key="sk-xxai-your-key")
...
client = FangcunGuard("sk-xxai-your-key")
