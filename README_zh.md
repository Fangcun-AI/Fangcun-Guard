...
Fangcun Guard 是一个面向企业 AI 应用与智能体的开源 AI 安全基础设施，提供内容安全、提示词攻击、数据泄漏、Agent 运行时行为安全和事实依据校验等能力。

## 产品亮点

- **Fangcun Guard Router**：系统预定义 15 个安全维度，分类路由自动识别输入内容所属维度并分发给对应的检测模型，用户可为每个维度自由选择模型。
...
详见 [Fangcun Guard Router 文档](docs/features/GUARD_MODEL_ROUTER_zh.md)
...
- [Fangcun Guard Router](docs/features/GUARD_MODEL_ROUTER_zh.md) — 多模型路由配置
- [Fangcun Core Shield](docs/features/BASIC_GUARD_OVERVIEW_zh.md) — 安全基座能力
- [Agent Runtime Firewall](docs/features/AGENT_SAFETY_OVERVIEW_zh.md) — Agent 防护
